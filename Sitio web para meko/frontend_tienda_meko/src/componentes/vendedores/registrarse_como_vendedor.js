...
function Registrarse_como_vendedor (){
    ...
    const activarBoton = (RegistrarseFormData.nombre!=='') && (RegistrarseFormData.apellidos!=='') && (RegistrarseFormData.correo!=='') && (RegistrarseFormData.usuario!=='') && (RegistrarseFormData.contrasenha!=='') && (RegistrarseFormData.telefono!=='')  && (RegistrarseFormData.direccion!=='')
                        ...
                        <div className={"card-body"}>
                            ...
                            <form>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="direccion" name="direccion" onChange={inputHandler} value={RegistrarseFormData.direccion}
...
export default Registrarse_como_vendedor;
